% arch_phase1.tex — Phase 1, "architecture-diagram" style (isometric volumes, two branches).
% Standalone TikZ; compile with:  pdflatex arch_phase1.tex
...
\node[dim, above=0.5mm of bbn] {$B$\ \ $3\!\times\!3$};
...
\node[dim, below=1.5mm of kks] {joint kernel $K$\\[1pt] $3N\!\times\!3N$};

% ================= HEAD =================
\node[op=gpink, text width=22mm, text=pinkink] (head) at (19.55,-0.1)
  {\textbf{exact conjugate}\\[1pt] \textbf{GP posterior}};
...
\node[dim, below=1.4mm of obs] {performance MIDI\\[1pt] $\tilde y$,\ $N\!\times\!3$};

\node[op=gverm, text width=24mm, line width=1.1pt, text=gverm] (lik) at (19.55,-4.4)
  {\textbf{likelihood}\\[1pt] \tiny $\tilde y=y+e$ on \emph{observed} notes;\\[-1pt] \tiny masked notes contribute none};
