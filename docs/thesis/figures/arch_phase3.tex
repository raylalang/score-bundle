...
\node[op=ggreen, text width=16mm, fill=ggreen!8] (noise) at (14.6,-3.6) {$\operatorname{diag}(\varsigma^2)\otimes I$\\ \tiny prior noise term};

\cuboid{16.25}{-0.85}{1.15}{1.45}{0.34}{ggreen}{kk}
\node[dim, below=1.5mm of kks] {prior $p(z)$\\[1pt] the same kernel $K$};
