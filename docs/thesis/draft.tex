...
channel is significant in either regime. This replicates the route-(A) pattern at
the feature level --- \textbf{the pretrained music model already carries the tonal,
metrical, and repetition signal the hand-built theory columns encode} --- and it
sharpens the attribution story of \S\ref{sec:attribution}: part of what the
embeddings contribute demonstrably \emph{is} this structure. The columns remain in
the codebase as an interpretable probe, off by default.
