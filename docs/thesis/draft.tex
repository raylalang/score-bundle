...
positivity and positive semidefiniteness hold by construction (quasi-Newton, with a
derivative-free simplex polish and a simplex-only fallback). One evidence per piece
