...
$\alpha\to\infty$ limit); (v) the symmetric normalized Laplacian \eqref{eq:lapsym}
inside the additive form; and (vi) the more experimental \emph{music-theory-informed} graphs of
\S\ref{sec:graphvariants}: tonal-distance edges (circle-of-fifths pitch-class distance
...
differ. Figure~\ref{fig:arch-phase2} makes the claim precise: relative to
