...
players, and wind players add to sustained notes. Three numbers describe it
per note: the rate $f_i^{\mathrm{vib}}$ (how many oscillations per second,
typically five to eight), the extent $\gamma_i$ (how far the pitch swings
from the centre at its peak, in cents --- commonly a few tens), and the
...
noise of \eqref{eq:phase2-noise} becomes substantive in Phase~2. The
...
from the identifiability rule (the per-track vibrato-identifiable fraction
ranges from $2\%$ to $97\%$ with median $38\%$ ---
