...
stationary colored floor cannot reach. The constraint therefore sharpens to
its final form: calibration in Phase~3 requires residual structure
correlated with the model's own directions --- a marginalized pitch-curve
deviation prior around the parametric curve, in the spirit of the amplitude
marginalization of \eqref{eq:collapsed} --- not a richer point model
(measured: insufficient) and not a generic colored noise floor (measured:
insufficient). This measured
