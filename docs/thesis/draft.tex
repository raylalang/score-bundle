...
discipline the thesis already runs on. Waveform-native calibration --- a
bridge model for the estimand gap --- is the frontier beyond that. This
measured constraint, not the synthesis sketch, is what the phase's
