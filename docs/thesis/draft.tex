...
error. The constraint therefore sharpens: calibration in Phase 3 must come
from the noise side --- a residual model that carries the structured misfit
--- not from enriching the point parameterization. This measured
