...
the \emph{within-note} structure this thesis measures but does not yet
model --- a quasi-periodic vibrato whose rate and extent drift --- and
\S\ref{ch:future} names the two slots where they would enter: a
curve-level estimator and the Phase-3 pitch-curve prior. The design
...
calibration --- names its own follow-up: a correlated (or heavy-tailed)
$\tau$ noise row that can represent alignment error's structure along
score time, which the diagonal row provably cannot. \textbf{The tonal
...
(\cite{wilson2013,remes2017,alvarado2016}; supervisor-suggested) supply
the missing ingredient's principled form: a quasi-periodic,
drift-capable prior on the within-note pitch curve, Gaussian and hence
compatible with the collapsed likelihood --- the deviation prior of
\S\ref{sec:phase3-study} with a spectral mixture in place of the bump
basis. Figure~\ref{fig:arch-phase3} shows what survives and what breaks:
