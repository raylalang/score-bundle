...
curve-level measure (4) favoured the GP, but the follow-up at the
waveform level (\texttt{results/phase3\_smprior\_dev.md}) measured no
gain there either. This note is kept as the design record; the sine
estimator remains the pipeline's estimator.}}
\end{center}
