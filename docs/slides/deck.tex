...
\begin{frame}{Results: timing $\tau$ (RMSE, by masking level)}
  ...
  \midrule
  50\% & \textbf{0.162} & 0.163 & 0.162 & \ldots & 0.172 \\
  40\% & \textbf{0.152} & 0.154 & 0.152 & 0.158 & 0.163 \\
  30\% & \textbf{0.157} & 0.159 & 0.159 & \ldots & 0.170 \\
  20\% & \textbf{0.149} & 0.151 & 0.150 & \ldots & 0.161 \\
  10\% & \textbf{0.154} & 0.156 & 0.157 & \ldots & 0.167 \\
...
\begin{frame}{Results: articulation $\log r$ (RMSE, by masking level)}
  ...
  hidden & proposed & no graph & no music model & mean + smoothing & MLP ens. \\
  \midrule
  50\% & \textbf{0.618} & 0.635 & 0.626 & \ldots & 0.761 \\
  40\% & \textbf{0.601} & 0.627 & 0.615 & 0.633 & 0.757 \\
  30\% & \textbf{0.592} & 0.620 & 0.607 & \ldots & 0.761 \\
  20\% & \textbf{0.587} & 0.603 & 0.616 & \ldots & 0.771 \\
  10\% & \textbf{0.577} & 0.584 & 0.612 & \ldots & 0.770 \\
...
\begin{frame}{Results: dynamics $v$ (RMSE, by masking level)}
  ...
  hidden & proposed & no graph & no music model & mean + smoothing & MLP ens. \\
  \midrule
  50\% & \textbf{0.074} & 0.083 & 0.076 & \ldots & 0.096 \\
  40\% & \textbf{0.072} & 0.083 & 0.075 & 0.078 & 0.095 \\
  30\% & \textbf{0.070} & 0.080 & 0.073 & \ldots & 0.091 \\
  20\% & \textbf{0.068} & 0.074 & 0.071 & \ldots & 0.088 \\
  10\% & \textbf{0.068} & 0.071 & 0.072 & \ldots & 0.087 \\
