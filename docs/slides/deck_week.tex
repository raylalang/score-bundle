...
\begin{frame}{What I did this week}
  \begin{itemize}
    \item I measured instead of building. Seven development studies, each
          answering a question the project had already written down.
    \item Two questions came from your kernel pointers. The rest came from
          limitations the thesis had documented about itself.
    \item Everything is development level and exploratory. Published
          tables are unchanged. Adopted machinery is opt in, pinned by
          tests, and any reported protocol change gets its own
          registration.
  \end{itemize}
  \vfill
  {\small\textcolor{muted}{Ledger: results/exploration\_week\_2026-09.md.
  All starred numbers on these slides survive a Benjamini Hochberg pass
  over the whole week.}}
\end{frame}
