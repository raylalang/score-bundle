...
\begin{frame}{What I would like from you today}
  ...
  \begin{enumerate}
    ...
    \item \textbf{The kernels are your call}: the measured default is to
          close the question. GSM stays gated, and a revival of the curve
          prior would need the band location marginalized rather than
          pinned. Unless you see a reason to pursue a variant, I would
          spend the next cycle on the timing registration.
  \end{enumerate}
  \vfill
